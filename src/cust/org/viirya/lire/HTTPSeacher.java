 ...
 */
public class HTTPSeacher {

    private String index_path = null;
    private IndexReader reader = null;
    private SiftLocalFeatureHistogramSparseImageSearcher searcher = null;
    ...
    public class ServiceHandler extends AbstractHandler {
        ...
        private HTTPSeacher seacher = null;
        ...
        public void setService(HTTPSeacher instance) {
                seacher = instance;
        }
    }
    ...
    public void init(String path, double th) throws IOException {
        index_path = path;
        reader = IndexReader.open(FSDirectory.open(new File(index_path)));
        searcher = new SiftLocalFeatureHistogramSparseImageSearcher(100);
    ...
    public static void main (String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println("Usage: CommandLineSeacher [index path] [port] [threshold]");
            System.exit(1);
        }
        ...
        HTTPSeacher seacher = new HTTPSeacher();
