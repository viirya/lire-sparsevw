 ...
 */
public class CommandLineSeacherbyFeature {


    public static void search(String index_path, String feature) throws IOException {
    ...
    public static void main (String[] args) throws IOException {
      if (args.length != 2) {
          System.err.println("Usage: CommandLineSeacherbyFeature [index path] [feature]");
          System.exit(1);
      }
